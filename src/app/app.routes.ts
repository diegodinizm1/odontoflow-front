...
export const routes: Routes = [
  ...
  { path: 'agendar/:slug', loadComponent: () => import('./features/booking/public-booking').then(m => m.PublicBookingComponent) },
  {
    ...
    children: [
      ...
      { path: 'cobrancas',         loadComponent: () => import('./features/charges/charges').then(m => m.ChargesComponent) },
      { path: 'perfil',            loadComponent: () => import('./features/account/profile').then(m => m.ProfileComponent) },
      { path: 'configuracoes',     loadComponent: () => import('./features/account/settings').then(m => m.SettingsComponent) },
